<div class="sidebar">
    ...
    <ul>
        ...
        <?php if ($this->user->isAdmin() || $this->user->isCurrentUser($user['id'])): ?>
            <?php /*    <?php if ($this->user->hasAccess('UserViewController', 'timesheet')): ?>
            ...
            <?php endif ?> */ ?>
         <?php /*    <?php if ($this->user->hasAccess('UserViewController', 'lastLogin')): ?>
            ...
            <?php endif ?> */ ?>
         <?php /* <?php if ($this->user->hasAccess('UserViewController', 'sessions')): ?>
            ...
            <?php endif ?> */ ?>
        <?php /* <?php if ($this->user->hasAccess('UserViewController', 'passwordReset')): ?>
    ...
    <ul>
        <?php if ($this->user->isAdmin() || $this->user->isCurrentUser($user['id'])): ?>
            ...
            <?php /*    <?php if ($this->user->isCurrentUser($user['id']) && $this->user->hasAccess('TwoFactorController', 'index')): ?>
         ...
         <?php /*    <?php elseif ($this->user->hasAccess('TwoFactorController', 'disable') && $user['twofactor_activated'] == 1): ?>
         ...
         <?php /*    <?php if ($this->user->hasAccess('UserViewController', 'share')): ?>
            ...
            <?php endif ?> */ ?>
        <?php /*    <?php if ($this->user->hasAccess('UserViewController', 'notifications')): ?>
            ...
            <?php endif ?> */ ?>
        <?php /*    <?php if ($this->user->hasAccess('UserViewController', 'external')): ?>
            ...
            <?php endif ?> */ ?>
        <?php /*    <?php if ($this->user->hasAccess('UserViewController', 'integrations')): ?>
            ...
            <?php endif ?> */ ?>
         <?php /*   <?php if ($this->user->hasAccess('UserApiAccessController', 'show')): ?>
        ...
        <?php /*<?php if ($this->user->hasAccess('UserCredentialController', 'changeAuthentication')): ?>

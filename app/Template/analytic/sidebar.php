<div class="sidebar">
    <ul>
        ...
        <?php /* <li <?= $this->app->checkMenuSelection('AnalyticController', 'cfd') ?>>
            <?= $this->modal->replaceLink(t('Cumulative flow diagram'), 'AnalyticController', 'cfd', array('project_id' => $project['id'])) ?>
        </li> */ ?>
       <?php /* <li <?= $this->app->checkMenuSelection('AnalyticController', 'burndown') ?>>
        ...
        <?php /*  <li <?= $this->app->checkMenuSelection('AnalyticController', 'leadAndCycleTime') ?>>
        ...
        <?php /* <li <?= $this->app->checkMenuSelection('AnalyticController', 'estimatedVsActualByColumn') ?>>

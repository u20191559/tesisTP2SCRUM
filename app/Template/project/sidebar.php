<div class="sidebar">
    <ul>
        ...
        <?php if ($this->user->hasProjectAccess('ProjectEditController', 'show', $project['id'])): ?>
            ...
            <?php /* <li <?= $this->app->checkMenuSelection('SwimlaneController') ?>>
                <?= $this->url->link(t('Swimlanes'), 'SwimlaneController', 'index', array('project_id' => $project['id'])) ?>
            </li> */ ?>
            <?php /* <li <?= $this->app->checkMenuSelection('CategoryController') ?>>
            ...
            <?php endif ?>
            <?php /* <li <?= $this->app->checkMenuSelection('ActionController') ?>>
                 <?= $this->url->link(t('Automatic actions'), 'ActionController', 'index', array('project_id' => $project['id'])) ?>
                </li> */ ?>

            <?php /* <li <?= $this->app->checkMenuSelection('ProjectViewController', 'duplicate') ?>>
